...
# Cloud Run job for automating revision requests (Round 2)
resource "google_cloud_run_v2_job" "icat_pkp_ojs_automate_revisions" {
  name     = "icat-pkp-ojs-automate-revisions"
  location = local.region
  project  = local.project_id
