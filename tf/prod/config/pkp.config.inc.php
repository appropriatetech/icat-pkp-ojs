...
driver = mysqli
host = ${PKP_DB_HOST}
username = ${PKP_DB_USER}
password = ${PKP_DB_PASSWORD}
name = ${PKP_DB_NAME}
...
smtp_server = ${PKP_SMTP_HOST}
smtp_port = ${PKP_SMTP_PORT}

; Enable SMTP authentication
; Supported smtp_auth: ssl, tls (see PHPMailer SMTPSecure)
smtp_auth = tls
smtp_username = "${PKP_SMTP_USER}"
smtp_password = "${PKP_SMTP_PASSWORD}"

; PM-B-broadcast-dTlMo30zvYV651IbFacB7
; uhk05aIFdKi3KKUI4a6aZrfjmXVZoOjAh6-x

; PM-T-outbound-YA-cQy21-u_eTeUFdsG9f5
; S38894HyTrDeq9JOTi2vASMnWW3NIOF6fnA8
